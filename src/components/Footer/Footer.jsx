                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                        <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                            ...
                            <Link href="/contact" className="py-2.5 px-5 h-9 block w-fit bg-red-400 rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-red-600 lg:mx-0">
                                Contact us
                            </Link>
                        </div>
                        {/* End Col */}
                        <div className="lg:mx-auto text-left ">
                            ...
                            <ul className="text-sm  transition-all duration-500">
                                ...
                                <li><Link href="/procedure" className=" text-gray-600 hover:text-gray-900">Procedure</Link></li>
                            </ul>
                        </div>
                        {/* End Col */}
                        <div className="lg:mx-auto text-left ">
                            ...
                            <ul className="text-sm  transition-all duration-500">
                                <li className="mb-6"><Link href="javascript:;" className="text-gray-600 hover:text-gray-900">Eudcation</Link></li>
                                <li className="mb-6"><Link href="javascript:;" className=" text-gray-600 hover:text-gray-900">Leadership Program</Link></li>
                                <li><Link href="javascript:;" className=" text-gray-600 hover:text-gray-900">Exploration / Education Tour</Link></li>
                            </ul>
                        </div>
                        {/* End Col */}
                        <div className="lg:mx-auto text-left ">
                            ...
                            <ul className="text-sm  transition-all duration-500">
                                <li className="mb-6"><Link href="javascript:;" className="text-gray-600 hover:text-gray-900">Phone: +977 11111111</Link></li>
                                <li className="mb-6"><Link href="javascript:;" className=" text-gray-600 hover:text-gray-900">Email: 0i0wY@example.com</Link></li>
                                <li ><Link href="javascript:;" className=" text-gray-600 hover:text-gray-900">Website: www.mfkf.org</Link></li>
                            </ul>
                        </div>
                        {/* End Col */}
                        <div className="lg:mx-auto text-left ">
                            ...
                            <Link href="/donate" className="flex items-center justify-center gap-2 border border-red-400 rounded-full py-3 px-6 w-fit lg:mx-0  text-sm text-red-400 font-semibold transition-all duration-500 hover:bg-indigo-50">Dontae<svg width="15" height="12" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
