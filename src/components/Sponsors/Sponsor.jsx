  ...
  return (
    <section className="dark:bg-gray-100 dark:text-gray-800">
      <div className="container px-6 py-12 mx-auto">
        <motion.div
          className="grid items-center gap-4 xl:grid-cols-5"
        ...
        >
          ...
          >
            <h2 className="text-4xl font-bold">Know what our sponsors like to say</h2>
            <p className="dark:text-gray-600">
              We appreciate all their support and encouragement and try to make the best out of their help and support. Thank you all.
            </p>
          </motion.div>

          {/* Right Column - Sponsor Cards */}
          <motion.div className="p-6 xl:col-span-3" variants={containerVariants}>
            <div className="grid gap-4 md:grid-cols-2">
              {/* First Column */}
              <motion.div className="grid content-center gap-4" variants={containerVariants}>
                <motion.div
